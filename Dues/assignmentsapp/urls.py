...
urlpatterns = [
    path('get-all/reviewee/', get_user_assignments_reviewee, name='get_user_assignments_reviewee'),
    path('get-all/reviewer/', get_user_assignments_reviewer, name='get_user_assignments_reviewer'),
